...
![](img/mesh-conversion-optimization.jpg)
...
![](img/reducing-mesh-complexity.jpg)
...
{{< notes >}}
Blender is a powerful open-source tool not just for rendering 3D models but also for cutting and interacting with volumetric datasets. 
{{< /notes >}}
...
TODO list of web based viewers

---

## Web based viewers
### Displaying 3D data in Neuroglancer
{{< notes >}}
TODO
{{< /notes >}}
